...
<nav class="navbar navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php">Projeto Interdisciplinar - Lucas Tozo</a>
  ...
  <div
    ...
    style="background-image: url('Images/background.png'); height: 250px;">
    <div class="mask" style="background-color: rgba(0, 0, 0, 0.6); margin-top: 50px;">
      <div class="d-flex justify-content-center align-items-center h-100">
        <div class="text-white">
          <h1 class="mb-1">Site PW</h1>
          <h2 class="mb-1">3ºB - Informática</h2>
          <h4>Lucas Tozo Monção</h4>
        </div>
      </div>
    </div>
  </div>
